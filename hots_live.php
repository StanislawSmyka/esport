...
<body>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a tabindex="-1" href="cal-lol.php">Kalendarz rozgrywek</a></li>
								<li class="divider"></li>
                    ...
                    <li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a tabindex="-1" href="cal-hs.php">Kalendarz rozgrywek</a></li>
								<li class="divider"></li>
					...
					<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a tabindex="-1" href="cal-csgo.php">Kalendarz rozgrywek</a></li>
								<li class="divider"></li>
					...
					<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a tabindex="-1" href="cal-hots.php">Kalendarz rozgrywek</a></li>
								<li class="divider"></li>
    ...
    <div class="container">
		...
		<?php
		$results = mysqli_query($db, "SELECT * FROM streams Where game='Heroes of the Storm' ");
